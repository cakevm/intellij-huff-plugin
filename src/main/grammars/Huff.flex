...
<YYINITIAL> {
    ...
    "//"                    {
       ...
       "__tablesize"          { return BUILDIN_FN_TABLESIZE; }
       "__codesize"           { return BUILDIN_FN_CODESIZE; }
       "__tablestart"         { return BUILDIN_FN_TABLESTART; }
       "__FUNC_SIG"           { return BUILDIN_FN_FUNC_SIG; }
       "__EVENT_HASH"         { return BUILDIN_FN_EVENT_HASH; }
       "__ERROR"              { return BUILDIN_FN_ERROR; }
       "__RIGHTPAD"           { return BUILDIN_FN_RIGHTPAD; }
       "__CODECOPY_DYN_ARG"   { return BUILDIN_FN_CODECOPY_DYN_ARG; }
       "__VERBATIM"           { return BUILDIN_FN_VERBATIM; }
