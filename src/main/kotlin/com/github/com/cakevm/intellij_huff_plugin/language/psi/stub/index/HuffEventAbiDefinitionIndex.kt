...
class HuffEventAbiDefinitionIndex : StringStubIndexExtension<HuffNamedElement>() {
  companion object {
    val KEY: StubIndexKey<String, HuffNamedElement> = StubIndexKey.createIndexKey(HuffEventAbiDefinitionIndex::class.java.simpleName)
  }
